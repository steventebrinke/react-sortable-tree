!function(root, factory) {
	 ...
	 */
        function toggleSelectedForAll(_ref12) {
            var treeData = _ref12.treeData, _ref12$selected = _ref12.selected, selected = void 0 === _ref12$selected || _ref12$selected;
            return map({
                treeData: treeData,
                callback: function(_ref13) {
                    var node = _ref13.node;
                    return _extends({}, node, {
                        selected: selected
                    });
                },
                getNodeKey: function(_ref14) {
	 ...
	 */
        function changeNodeAtPath(_ref15) {
            var treeData = _ref15.treeData, path = _ref15.path, newNode = _ref15.newNode, getNodeKey = _ref15.getNodeKey, _ref15$ignoreCollapse = _ref15.ignoreCollapsed, ignoreCollapsed = void 0 === _ref15$ignoreCollapse || _ref15$ignoreCollapse, RESULT_MISS = "RESULT_MISS", traverse = function traverse(_ref16) {
                var _ref16$isPseudoRoot = _ref16.isPseudoRoot, isPseudoRoot = void 0 !== _ref16$isPseudoRoot && _ref16$isPseudoRoot, node = _ref16.node, currentTreeIndex = _ref16.currentTreeIndex, pathIndex = _ref16.pathIndex;
	 ...
	 */
        function removeNodeAtPath(_ref17) {
            var treeData = _ref17.treeData, path = _ref17.path, getNodeKey = _ref17.getNodeKey, _ref17$ignoreCollapse = _ref17.ignoreCollapsed, ignoreCollapsed = void 0 === _ref17$ignoreCollapse || _ref17$ignoreCollapse;
	 ...
	 */
        function getNodeAtPath(_ref18) {
            var treeData = _ref18.treeData, path = _ref18.path, getNodeKey = _ref18.getNodeKey, _ref18$ignoreCollapse = _ref18.ignoreCollapsed, ignoreCollapsed = void 0 === _ref18$ignoreCollapse || _ref18$ignoreCollapse, foundNodeInfo = null;
            try {
                changeNodeAtPath({
                    treeData: treeData,
                    path: path,
                    getNodeKey: getNodeKey,
                    ignoreCollapsed: ignoreCollapsed,
                    newNode: function(_ref19) {
                        var node = _ref19.node, treeIndex = _ref19.treeIndex;
	 ...
	 */
        function addNodeUnderParent(_ref20) {
            var treeData = _ref20.treeData, newNode = _ref20.newNode, _ref20$parentKey = _ref20.parentKey, parentKey = void 0 === _ref20$parentKey ? null : _ref20$parentKey, getNodeKey = _ref20.getNodeKey, _ref20$ignoreCollapse = _ref20.ignoreCollapsed, ignoreCollapsed = void 0 === _ref20$ignoreCollapse || _ref20$ignoreCollapse, _ref20$expandParent = _ref20.expandParent, expandParent = void 0 !== _ref20$expandParent && _ref20$expandParent;
            ...
            var insertedTreeIndex = null, hasBeenAdded = !1, changedTreeData = map({
                ...
                getNodeKey: getNodeKey,
                ignoreCollapsed: ignoreCollapsed,
                callback: function(_ref21) {
                    var node = _ref21.node, treeIndex = _ref21.treeIndex, path = _ref21.path, key = path ? path[path.length - 1] : null;
        ...
        function addNodesAtDepthAndIndex(_ref22) {
            var targetDepth = _ref22.targetDepth, minimumTreeIndex = _ref22.minimumTreeIndex, newNodes = _ref22.newNodes, ignoreCollapsed = _ref22.ignoreCollapsed, expandParent = _ref22.expandParent, _ref22$isPseudoRoot = _ref22.isPseudoRoot, isPseudoRoot = void 0 !== _ref22$isPseudoRoot && _ref22$isPseudoRoot, isLastChild = _ref22.isLastChild, node = _ref22.node, currentIndex = _ref22.currentIndex, currentDepth = _ref22.currentDepth, getNodeKey = _ref22.getNodeKey, _ref22$path = _ref22.path, path = void 0 === _ref22$path ? [] : _ref22$path, selfPath = function(n) {
	 ...
	 */
        function insertNodes(_ref23) {
            var treeData = _ref23.treeData, targetDepth = _ref23.depth, minimumTreeIndex = _ref23.minimumTreeIndex, newNodes = _ref23.newNodes, _ref23$getNodeKey = _ref23.getNodeKey, getNodeKey = void 0 === _ref23$getNodeKey ? function() {} : _ref23$getNodeKey, _ref23$ignoreCollapse = _ref23.ignoreCollapsed, ignoreCollapsed = void 0 === _ref23$ignoreCollapse || _ref23$ignoreCollapse, _ref23$expandParent = _ref23.expandParent, expandParent = void 0 !== _ref23$expandParent && _ref23$expandParent;
            if (0 === newNodes.length) throw new Error("At least one node must be inserted.");
	 ...
	 */
        function insertNode(_ref24) {
            var treeData = _ref24.treeData, depth = _ref24.depth, minimumTreeIndex = _ref24.minimumTreeIndex, newNode = _ref24.newNode, _ref24$getNodeKey = _ref24.getNodeKey, getNodeKey = void 0 === _ref24$getNodeKey ? function() {} : _ref24$getNodeKey, _ref24$ignoreCollapse = _ref24.ignoreCollapsed, ignoreCollapsed = void 0 === _ref24$ignoreCollapse || _ref24$ignoreCollapse, _ref24$expandParent = _ref24.expandParent, expandParent = void 0 !== _ref24$expandParent && _ref24$expandParent;
            return insertNodes({
                treeData: treeData,
                depth: depth,
                minimumTreeIndex: minimumTreeIndex,
	 ...
	 */
        function getFlatDataFromTree(_ref25) {
            var treeData = _ref25.treeData, getNodeKey = _ref25.getNodeKey, _ref25$ignoreCollapse = _ref25.ignoreCollapsed, ignoreCollapsed = void 0 === _ref25$ignoreCollapse || _ref25$ignoreCollapse;
            ...
            return walk({
                ...
                getNodeKey: getNodeKey,
                ignoreCollapsed: ignoreCollapsed,
                callback: function(_ref26) {
                    var node = _ref26.node, lowerSiblingCounts = _ref26.lowerSiblingCounts, path = _ref26.path, treeIndex = _ref26.treeIndex;
                    flattened.push({
                        node: node,
                        lowerSiblingCounts: lowerSiblingCounts,
                        path: path,
	 ...
	 */
        function getTreeFromFlatData(_ref27) {
            var flatData = _ref27.flatData, _ref27$getKey = _ref27.getKey, getKey = void 0 === _ref27$getKey ? function(node) {
                return node.id;
            } : _ref27$getKey, _ref27$getParentKey = _ref27.getParentKey, getParentKey = void 0 === _ref27$getParentKey ? function(node) {
                return node.parentId;
            } : _ref27$getParentKey, _ref27$rootKey = _ref27.rootKey, rootKey = void 0 === _ref27$rootKey ? "0" : _ref27$rootKey;
            if (!flatData) return [];
	 ...
	 */
        function find(_ref28) {
            var getNodeKey = _ref28.getNodeKey, treeData = _ref28.treeData, searchQuery = _ref28.searchQuery, searchMethod = _ref28.searchMethod, searchFocusOffset = _ref28.searchFocusOffset, _ref28$expandAllMatch = _ref28.expandAllMatchPaths, expandAllMatchPaths = void 0 !== _ref28$expandAllMatch && _ref28$expandAllMatch, _ref28$expandFocusMat = _ref28.expandFocusMatchPaths, expandFocusMatchPaths = void 0 === _ref28$expandFocusMat || _ref28$expandFocusMat, matchCount = 0, trav = function trav(_ref29) {
                var _ref29$isPseudoRoot = _ref29.isPseudoRoot, isPseudoRoot = void 0 !== _ref29$isPseudoRoot && _ref29$isPseudoRoot, node = _ref29.node, currentIndex = _ref29.currentIndex, _ref29$path = _ref29.path, path = void 0 === _ref29$path ? [] : _ref29$path, matches = [], isSelfMatch = !1, hasFocusMatch = !1, selfPath = isPseudoRoot ? [] : [].concat(_toConsumableArray(path), [ getNodeKey({
                    node: node,
                    treeIndex: currentIndex
        ...
        exports.map = map, exports.toggleExpandedForAll = toggleExpandedForAll, exports.toggleSelectedForAll = toggleSelectedForAll, 
        exports.changeNodeAtPath = changeNodeAtPath, exports.removeNodeAtPath = removeNodeAtPath, 
        exports.getNodeAtPath = getNodeAtPath, exports.addNodeUnderParent = addNodeUnderParent, 
        exports.insertNodes = insertNodes, exports.insertNode = insertNode, exports.getFlatDataFromTree = getFlatDataFromTree, 
	...
	*/
    ...
    function(module, exports, __webpack_require__) {
        ...
        var NodeRendererDefault = function(_ref) {
            var scaffoldBlockPxWidth = _ref.scaffoldBlockPxWidth, toggleChildrenVisibility = _ref.toggleChildrenVisibility, connectDragPreview = _ref.connectDragPreview, connectDragSource = _ref.connectDragSource, isDragging = _ref.isDragging, isOver = _ref.isOver, canDrop = _ref.canDrop, node = _ref.node, draggedNodes = _ref.draggedNodes, path = _ref.path, treeIndex = _ref.treeIndex, isSearchMatch = _ref.isSearchMatch, isSearchFocus = _ref.isSearchFocus, buttons = _ref.buttons, className = _ref.className, _ref$style = _ref.style, style = void 0 === _ref$style ? {} : _ref$style, _ref$selectNode = (_ref.startDrag, 
            _ref.endDrag, _ref.selectNode), selectNode = void 0 === _ref$selectNode ? function() {} : _ref$selectNode, otherProps = _objectWithoutProperties(_ref, [ "scaffoldBlockPxWidth", "toggleChildrenVisibility", "connectDragPreview", "connectDragSource", "isDragging", "isOver", "canDrop", "node", "draggedNodes", "path", "treeIndex", "isSearchMatch", "isSearchFocus", "buttons", "className", "style", "startDrag", "endDrag", "selectNode" ]), handle = void 0;
            if ("function" == typeof node.children && node.expanded) // Show a loading symbol on the handle when the children are expanded
    ...
    function(module, exports, __webpack_require__) {
        ...
        var _treeNode = __webpack_require__(8), _treeNode2 = _interopRequireDefault(_treeNode), _nodeRendererDefault = __webpack_require__(6), _nodeRendererDefault2 = _interopRequireDefault(_nodeRendererDefault), _treeDataUtils = __webpack_require__(1), _genericUtils = __webpack_require__(11), _defaultHandlers = __webpack_require__(5), _dragAndDropUtils = __webpack_require__(10), _reactSortableTree = __webpack_require__(18), _reactSortableTree2 = _interopRequireDefault(_reactSortableTree), dndTypeCounter = 1, ReactSortableTree = function(_Component) {
            function ReactSortableTree(props) {
                ...
                _this.moveNodes = _this.moveNodes.bind(_this), _this.startDrag = _this.startDrag.bind(_this), 
                _this.dragHover = _this.dragHover.bind(_this), _this.endDrag = _this.endDrag.bind(_this), 
                _this.selectNode = _this.selectNode.bind(_this), _this;
            }
            return _inherits(ReactSortableTree, _Component), _createClass(ReactSortableTree, [ {
                ...
                value: function(_ref3) {
                    var _this2 = this, nodes = _ref3.nodes, depth = _ref3.depth, minimumTreeIndex = _ref3.minimumTreeIndex, _insertNodes = (0, 
                    _treeDataUtils.insertNodes)({
                        ...
                        expandParent: !0,
                        getNodeKey: this.props.getNodeKey
                    }), treeData = _insertNodes.treeData, treeIndex = _insertNodes.treeIndex, path = _insertNodes.path;
                    this.props.onChange(treeData), this.props.onMoveNode && nodes.forEach(function(node) {
                        _this2.props.onMoveNode({
                            treeData: treeData,
                            node: node,
                            treeIndex: treeIndex,
                            path: path
                ...
                value: function(_ref4) {
                    var _this3 = this, node = _ref4.node, path = _ref4.path, event = _ref4.event, treeData = this.props.treeData, oldTreeData = treeData, clearSelected = !event.ctrlKey && !event.metaKey;
                    if (clearSelected) // Remove old selection.
                    treeData = (0, _treeDataUtils.toggleSelectedForAll)({
                        treeData: treeData,
                        selected: !1
                    }); else if (!node.selected) {
                        // Check if any ancestor is already selected.
                        for (var ancestorPath = path.slice(0, path.length - 1); ancestorPath.length > 0; ancestorPath.pop()) if ((0, 
                        _treeDataUtils.getNodeAtPath)({
                            treeData: treeData,
                            path: ancestorPath,
                            getNodeKey: this.props.getNodeKey
                        }).node.selected) // An ancestor is already selected, so do nothing.
                        return;
                        // Deselect all descendants.
                        (0, _treeDataUtils.toggleSelectedForAll)({
                            treeData: [ node ],
                            selected: !1
                    ...
                    if (// Change selection of node.
                    treeData = (0, _treeDataUtils.changeNodeAtPath)({
                        treeData: treeData,
                        path: path,
                        newNode: function(_ref5) {
                            var oldNode = _ref5.node;
                            return _extends({}, oldNode, {
                                selected: !oldNode.selected
                            });
                        },
                        getNodeKey: this.props.getNodeKey
                    }), this.props.onChange(treeData), this.props.onSelectedToggle) {
                        var deselectionTree = void 0;
                        deselectionTree = clearSelected ? oldTreeData : [ node ], // Notify deselected nodes
                        (0, _treeDataUtils.walk)({
                            treeData: deselectionTree,
                            callback: function(_ref6) {
                                var oldNode = _ref6.node;
                                oldNode.selected && _this3.props.onSelectedToggle({
                                    treeData: treeData,
                                    node: oldNode,
                                    selected: !1
                                });
                            },
                            getNodeKey: function(_ref7) {
                ...
                value: function(props) {
                    ...
                    nodeProps = props.node.selected ? (0, _treeDataUtils.find)(_extends({}, this.props, {
                        searchMethod: function(_ref8) {
                            var node = _ref8.node;
                            return node.selected;
                        }
                    })).matches : [ props ];
                    for (var draggingTreeData = this.props.treeData, i = nodeProps.length - 1; i >= 0; i--) draggingTreeData = (0, 
                    _treeDataUtils.removeNodeAtPath)({
                ...
                value: function(_ref9) {
                    var draggedNodes = _ref9.nodes, depth = _ref9.depth, minimumTreeIndex = _ref9.minimumTreeIndex, addedResult = (0, 
                    _treeDataUtils.insertNodes)({
                        treeData: this.state.draggingTreeData,
                        ...
                        minimumTreeIndex: minimumTreeIndex,
                        expandParent: !0
                    }), rows = this.getRows(addedResult.treeData), expandedParentPath = rows[addedResult.treeIndex].path, swapFrom = addedResult.treeIndex, swapTo = minimumTreeIndex, swapLength = draggedNodes.length + draggedNodes.map(function(draggedNode) {
                        return (0, _treeDataUtils.getDescendantCount)({
                            node: draggedNode
                        });
                    }).reduce(function(x, y) {
                        return x + y;
                ...
                value: function(dropResult) {
                    return dropResult ? void this.moveNodes(dropResult) : this.setState({
                        draggingTreeData: null,
                        swapFrom: null,
                        swapLength: null,
                        swapDepth: null,
                ...
                value: function() {
                    ...
                    (0, _treeDataUtils.walk)({
                        ...
                        getNodeKey: this.props.getNodeKey,
                        callback: function(_ref11) {
                            var node = _ref11.node, path = _ref11.path, lowerSiblingCounts = _ref11.lowerSiblingCounts, treeIndex = _ref11.treeIndex;
                        ...
                        list = _react2.default.createElement(_reactVirtualized.AutoSizer, null, function(_ref14) {
                            ...
                            return _react2.default.createElement(ScrollZoneVirtualList, _extends({}, scrollToInfo, {
                                ...
                                rowRenderer: function(_ref16) {
                                    var index = _ref16.index, key = _ref16.key, rowStyle = _ref16.style;
    ...
    function(module, exports, __webpack_require__) {
        ...
        function getTargetDepth(dropTargetProps, monitor) {
            ...
            if ("undefined" != typeof dropTargetProps.maxDepth && null !== dropTargetProps.maxDepth) {
                var draggedNodes = monitor.getItem().nodes, draggedChildDepth = Math.max.apply(Math, _toConsumableArray(draggedNodes.map(function(draggedNode) {
        ...
        function canDrop(dropTargetProps, monitor) {
            ...
            var targetDepth = getTargetDepth(dropTargetProps, monitor), draggedNodes = monitor.getItem().nodes, parentPath = dropTargetProps.path.slice(0, -1), parentNode = dropTargetProps.rows.find(function(row) {
            ...
            return (targetDepth < abovePath.length || "function" != typeof aboveNode.children) && (!(dropTargetProps.node === draggedNodes[0] && isHover === !0) || targetDepth !== dropTargetProps.path.length - 1) && ("undefined" == typeof parentNode || "undefined" == typeof parentNode.node.canHaveChildren || parentNode.node.canHaveChildren) && !(dropTargetProps.node.alwaysAtRootLevel && parentNode);
        }
        ...
        var _reactDnd = __webpack_require__(21), _reactDndHtml5Backend = __webpack_require__(22), _reactDndHtml5Backend2 = _interopRequireDefault(_reactDndHtml5Backend), _treeDataUtils = __webpack_require__(1), nodeDragSource = {
            ...
            isDragging: function(props, monitor) {
                var dropTargetNodes = monitor.getItem().nodes, draggedNode = props.node;
